  ...
  const fetchTimetable = async () => {
    try {
      const response = await axios.get(
        `https://tutor-backend-uyeb.onrender.com/api/timetables/teacher/${tutor.teacher_id}`
      );
...
const handleBookEvent = async () => {
  try {
    ...
    // Update backend data
    await axios.put(`https://tutor-backend-uyeb.onrender.com/api/timetables/${selectedEvent.timetable_id}`, {
      isbooked: true,
    });
   ...
   console.log(email)
   message.success("Booking is successful. Email was sent");
  } catch (error) {
