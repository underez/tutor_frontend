...
const Register = () => {
    ...
    const checkUsernameExists = async () => {
        try {
            const res = await axios.get(`https://tutor-backend-uyeb.onrender.com/api/members/check-username/${username}`);
    ...
    const onSubmit = async e => {
        ...
        try {
            ...
            const res = await axios.post('https://tutor-backend-uyeb.onrender.com/api/members', body, config);
